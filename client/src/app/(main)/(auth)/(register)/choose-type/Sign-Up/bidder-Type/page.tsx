        ...
        <div className="w-10/12 mx-auto text-xs text-end"> 
          ...
          <div className="mx-auto grid w-7/12 gap-6 mb-10">
            <div className="grid gap-2">
              <h1 className="text-3xl font-bold">Complete The Registration Process</h1>
            ...
            <div className="flex flex-col gap-5">
              ...
              <Link href={'/choose-type/Sign-Up/bidder-Type/Company-Info'} className="flex justify-between items-center shadow border hover:border-primary p-5 rounded accounType hover:bg-neutralBg">
                <div className="flex items-center gap-5">
                  <Image src={"/icons/companyIcon.svg"} width={50} height={50} alt="shape" className="depositorIcon"/>
                  <Image src={"/icons/HoverCompanyIcon.svg"} width={50} height={50} alt="shape" className="hidden hoverDepositorIcon"/>
                  <div>
