              ...
              <h1 className="text-3xl font-semibold">Create New Offer</h1>
                <div className="w-full gap-16 bg-white rounded-lg border shadow p-10 mt-5">
                    <div className="grid gap-4">
                        ...
                        <div className="grid gap-2">
                            <Label htmlFor="title" className="text-lg font-semibold">Category</Label>
                            <Popover open={categoryOpen} onOpenChange={categorySetOpen}>
                                <PopoverTrigger asChild>
                                    ...
                                    >
                                    {CategoryValue
                                        ? Categories.find((city) => city.value === CategoryValue)?.label
                                    ...
                                    <CommandGroup>
                                        ...
                                        {Categories.map((city, index) => (
                                            ...
                                            <Check
                                                className={cn(
                                                "mr-2 h-4 w-4",
                                                CategoryValue === city.value ? "opacity-100" : "opacity-0"
                                                )}
                                            />
                                            {city.label}
                                            </CommandItem>
