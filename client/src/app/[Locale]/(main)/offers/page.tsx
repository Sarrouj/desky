            ...
            <div className="">
              <div className="flex gap-2">
                <Input
                  ...
                  className="w-[200px] md:w-[250px] lg:w-[300px] xl:w-[400px]
              ...
              <ul className="flex items-center gap-2 text-sm mt-2">
                {filter.map((act, index) => (
                  <li
                    key={index}
                    className="bg-orange-300 text-white py-1.5 px-3.5 rounded-full cursor-pointer"
                  >
                ...
                {filter.length !== 0 ? (
                  <li
                    className="cursor-pointer text-primaryOrange font-semibold text-sm "
