...
const AddOfferForm = ({
  ...
  return (
    <div className="grid auto-rows-max items-start gap-4 md:gap-8 lg:col-span-2 mb-10 w-full mx-auto">
      <Tabs>
        <div className="w-full gap-16 bg-white rounded-lg border shadow p-5 md:p-10 ">
          <div className="grid gap-4">
            <div className="flex flex-col md:flex-row items-start w-full gap-2">
              <div className="grid gap-2 w-full md:w-2/4">
                <Label
                  htmlFor="title"
                ...
                <Popover open={open} onOpenChange={setOpen}>
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      role="combobox"
                      aria-expanded={open}
                      className={`w-[100%] justify-between  text-xs lg:text-sm ${
                        locationErrorMsg
                          ? "ring-0 border-2 border-red-600 focus:ring-0 focus-visible:ring-white focus-visible:ring-1"
                          : ""
                      }`}
            ...
            <div className="flex flex-col md:flex-row items-start w-full gap-2">
                  ...
                  <PopoverTrigger asChild>
                    ...
                    >
                      ...
                      {date ? (
                        ...
                        <span>{Content("datePlaceholder")}</span>
                      )}
                    </Button>
                  </PopoverTrigger>
              ...
              <div className="grid gap-2 w-full md:w-2/4">
                ...
                <Input
                  ...
                  className={`text-xs lg:text-sm ${
                    budgetErrorMsg
                      ? "ring-0 border-2 border-red-600 focus:ring-0 focus-visible:ring-white focus-visible:ring-1 text-xs lg:text-sm"
                      : ""
                  }`}
                />
                {budgetErrorMsg ? (
                  <p className="text-xs text-red-600">
                    {Content("errorMsg.Budget")}
                  </p>
                ) : null}
              </div>
            </div>
            <div className="flex flex-col md:flex-row items-end gap-2 w-full">
              ...
              {secondCategoryToggling ? (
                <Button
                  className="text-white text-xs w-full md:max-w-[100px]"
                ...
                <div className="grid gap-2 w-full">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-neutralGray text-xs lg:text-sm">
                      ({Content("Optional")})
                    </p>
                  </div>
